...
class OKXGlobalStream:
    ...
    def __init__(
        ...
        self._seen_ids = OrderedDict()  # Order preserved for LRU
        ...
        try:
            ...
            for t in trades:
                ...
                if tid and tid in self._seen_ids:
                    ...
                    self._seen_ids.move_to_end(tid)
                    continue
                if tid:
                    self._seen_ids[tid] = True
            ...
            # Honest LRU: remove oldest entries (at the beginning)
