...
class ParasiteHunter:
    ...
    def _undercut_collection(self, collection_address: str,
        ...
        our_existing_pre = our_existing if our_existing else self._find_our_offer(addr, chain)
        if our_existing_pre:
            existing_price = our_existing_pre["price"]
            existing_cur = our_existing_pre["currency"].upper()
