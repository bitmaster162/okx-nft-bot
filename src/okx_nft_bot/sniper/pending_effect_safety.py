        ...
        *,
        ...
        if success:
            ...
            try:
                ...
                finalized = durable.complete_success(
                    wallet=wallet,
                    chain=chain,
                    order_id=order_id,
                    tx_hash=tx_hash,
                ...
                # Atomic finalization rolls back on failure. Keep both the
                # in-memory latch and durable pre-effect reservation fail-closed.
                finalized = False
            if finalized:
                with lock:
