...
from okx_nft_bot.clients.http import StdlibHttpTransport, build_url, get_okx_global_limiter
...
class OKXMarketplaceClient:
    def __init__(self, settings: Settings, transport: StdlibHttpTransport | None = None) -> None:
        ...
        # Share a single global rate limiter across all OKX clients
        self.transport._rate_limiter = get_okx_global_limiter(settings.okx_rate_limit_per_sec)
